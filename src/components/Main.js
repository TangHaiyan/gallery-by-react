...
class GalleryByReactApp extends React.Component {
  ...
  center(index) {
    ...
    componentDidMount() {
      ...
      this.Constant.hPosRange.rigtSecX[0] = halfStageW + halfImgW;
      this.Constant.hPosRange.rightSecX[1] = stageW - halfImgW;

      this.Constant.yPosRange.y[0] = -halfImgH;
      this.Constant.yPosRange.y[1] = halfStageH - halfImgH * 3;
      //计算上侧区域图片排布位置的取值范围
   ...
   // console.log("stageH - halfImgH:"stageH - halfImgH);
    //计算上测区域图片排布的取值范围
    this.Constant.vPosRange.topY[0] = -halfImgH;
    this.Constant.vPosRange.topY[1] = halfStageH - halfImgH * 3;
